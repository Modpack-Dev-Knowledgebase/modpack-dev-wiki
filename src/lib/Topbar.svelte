...
<div class="bg-stone-800 flex w-full items-center justify-between p-2 h-12 sticky top-0 border-b border-stone-700 z-20">
  ...
  <div class="flex items-center grow">
    <button
      class="px-2 pr-3 sm:hidden focus-visible:outline-2 focus-visible:outline-mdw-yellow"
  ...
  <div class="flex items-center gap-2">
    <a
      ...
      class="p-2 rounded-lg py-1 flex items-center gap-2 hover:bg-stone-700 hover:text-white hover:font-medium aspect-square sm:aspect-auto focus-visible:outline-2 focus-visible:outline-mdw-yellow"
      aria-label="Edit">
      <IconEdit />
      <span class="hidden sm:block">Edit</span>
    </a>
    <button
      class="p-2 rounded-lg py-1 flex items-center gap-2 hover:bg-stone-700 hover:text-white hover:font-medium aspect-square sm:aspect-auto focus-visible:outline-2 focus-visible:outline-mdw-yellow cursor-pointer"
      aria-label="Copy URL"
      onclick={copyUrl}>
      <IconShare />
